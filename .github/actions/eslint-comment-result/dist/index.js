/******/ ;(() => {
  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 50: /***/ function (
      ...
      const file_command_1 = __nccwpck_require__(463)
      const utils_1 = __nccwpck_require__(54)
      const os = __importStar(__nccwpck_require__(37))
       ...
       * Summary exports
       */
      var summary_1 = __nccwpck_require__(977)
       ...
       */
      var summary_2 = __nccwpck_require__(977)
       ...
       * Path exports
       */
      var path_utils_1 = __nccwpck_require__(265)
    ...
    /***/ 463: /***/ function (
      ...
      const os = __importStar(__nccwpck_require__(37))
      const uuid_1 = __nccwpck_require__(35)
      const utils_1 = __nccwpck_require__(54)
    ...
    /***/ 779: /***/ function (
      ...
      const http_client_1 = __nccwpck_require__(120)
    ...
    /***/ 54: /***/ (__unused_webpack_module, exports) => {
      "use strict"
    ...
    /***/ 458: /***/ function (__unused_webpack_module, exports) {
      "use strict"
    ...
    /***/ 120: /***/ function (
      ...
      const tunnel = __importStar(__nccwpck_require__(530))
      var HttpCodes
      ;(function (HttpCodes) {
    ...
    /***/ 255: /***/ (__unused_webpack_module, exports) => {
      "use strict"
    ...
    /***/ 35: /***/ (__unused_webpack_module, exports, __nccwpck_require__) => {
      ...
      var _v2 = _interopRequireDefault(__nccwpck_require__(85))

      var _v3 = _interopRequireDefault(__nccwpck_require__(123))

      var _v4 = _interopRequireDefault(__nccwpck_require__(133))

      var _nil = _interopRequireDefault(__nccwpck_require__(806))

      var _version = _interopRequireDefault(__nccwpck_require__(71))

      var _validate = _interopRequireDefault(__nccwpck_require__(583))

      var _stringify = _interopRequireDefault(__nccwpck_require__(103))

      var _parse = _interopRequireDefault(__nccwpck_require__(208))
    ...
    /***/ 806: /***/ (__unused_webpack_module, exports) => {
      "use strict"
    ...
    /***/ 72: /***/ (__unused_webpack_module, exports) => {
      "use strict"
    ...
    /***/ 81: /***/ (__unused_webpack_module, exports, __nccwpck_require__) => {
      "use strict"
    ...
    /***/ 520: /***/ (
      ...
      var _rng = _interopRequireDefault(__nccwpck_require__(630))
    ...
    /***/ 85: /***/ (__unused_webpack_module, exports, __nccwpck_require__) => {
      ...
      var _md = _interopRequireDefault(__nccwpck_require__(992))
    ...
    /***/ 133: /***/ (
      ...
      var _sha = _interopRequireDefault(__nccwpck_require__(81))
    ...
    /***/ 155: /***/ function (
      ...
      exports.run = void 0
      /* eslint-disable */
      const core = __importStar(__nccwpck_require__(50))
      const node_fs_1 = __nccwpck_require__(561)
      const promises_1 = __nccwpck_require__(809)
      const message_1 = __nccwpck_require__(495)
      /**
      ...
      async function run() {
        try {
          ...
          if (!(0, node_fs_1.existsSync)(eslintOutputPath)) {
            core.info(
              `ESLint output not found at ${eslintOutputPath}. Skipping action 🚧`,
            )
            return
          }
          const eslintOutputText = await (0, promises_1.readFile)(
            eslintOutputPath,
            "utf-8",
          )
          const eslintResults = JSON.parse(eslintOutputText)
          core.info(
            `Found ESLint output:\ ${JSON.stringify(eslintResults, null, 2)}`,
          )
          const message = (0, message_1.createMessage)(eslintResults)
    ...
    /***/ 21: /***/ (__unused_webpack_module, exports) => {
      ...
      Object.defineProperty(exports, "__esModule", { value: true })
      exports.createCollapsableBlock =
        exports.createCodeBlock =
        exports.createImage =
          void 0
      function createImage({ src, align = "bottom", width = 20 }) {
      ...
      function createCollapsableBlock(summary, details) {
        return `
<details>
...
<summary>${summary}</summary>
  ...
  ${details}
      ...
      exports.createCollapsableBlock = createCollapsableBlock
    ...
    /***/ 495: /***/ function (
      ...
      const markdown_1 = __nccwpck_require__(21)
      const vendored_1 = __importDefault(__nccwpck_require__(891))
      ...
      function accumulateErrorsAndWarnings(results) {
        let errorCountAll = 0
      ...
      function createTitle({ hasErrorsAndWarnings, hasOnlyErrors }) {
        const eslintIcon = (0, markdown_1.createImage)({
      ...
      function createCodeBlockWithESLintOutput(results) {
        const stylishOutput = (0, vendored_1.default)(results)
        return (0, markdown_1.createCodeBlock)(stylishOutput, "sh")
      }
      function createFooter(accumulatedResults) {
        if (
      ...
      function createAutoFixSuggestions(listTitle) {
        const suggestions = [
      ...
      function createFrequentlyAskedQuestions() {
        ...
        const FAQs = [
          (0, markdown_1.createCollapsableBlock)(
...
\`\`\``,
    ...
    /***/ 891: /***/ function (
      ...
      Object.defineProperty(exports, "__esModule", { value: true })
      const text_table_1 = __importDefault(__nccwpck_require__(423))
      //------------------------------------------------------------------------------
      // Helpers
      //------------------------------------------------------------------------------
      /**
      ...
      function default_1(results) {
        ...
        results.forEach((result) => {
          ...
          output += `${(0, text_table_1.default)(
            ...
            .split("\n")
            .map((el) =>
              el.replace(/(\d+)\s+(\d+)/u, (_, p1, p2) => `${p1}:${p2}`),
            )
            .join("\n")}\n\n`
        })
  ...
  ;(() => {
    ...
    Object.defineProperty(exports, "__esModule", { value: true })
    const main_1 = __nccwpck_require__(155)
    ;(0, main_1.run)()
  })()
